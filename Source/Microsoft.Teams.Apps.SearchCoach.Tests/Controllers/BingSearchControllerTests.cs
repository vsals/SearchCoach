    ...
    public class BingSearchControllerTests
    {
        ...
        public async Task BingSearchValidInputValidContentsAsync()
        {
            ...
            var result = (ObjectResult)await this.bingSearchController.GetSearchResultAsync(
                BingSearchResultData.SearchString,
                BingSearchResultData.MarketValue,
                BingSearchResultData.FreshnessValue,
                BingSearchResultData.DomainValue).ConfigureAwait(false);
        ...
        public async Task BingSearchInvalidDomainBadRequestAsync()
        {
            ...
            this.bingSearchHelper
                .Setup(x => x.IsValidDomain(BingSearchResultData.InvalidDomainValue))
                .Returns(false);
            ...
            var result = (ObjectResult)await this.bingSearchController.GetSearchResultAsync(
                ...
                BingSearchResultData.MarketValue,
                BingSearchResultData.FreshnessValue,
                BingSearchResultData.InvalidDomainValue).ConfigureAwait(false);
        ...
        public async Task BingSearchTextWithHtmlValidContentsAsync()
        {
            ...
            // ACT
            var result = (ObjectResult)await this.bingSearchController.GetSearchResultAsync(
                BingSearchResultData.SearchStringWithHtmlContent,
                BingSearchResultData.MarketValue,
                BingSearchResultData.FreshnessValue,
                BingSearchResultData.DomainValue).ConfigureAwait(false);
        ...
        public async Task BingSearchTextWithScriptsValidContentsAsync()
        {
            ...
            // ACT
            var result = (ObjectResult)await this.bingSearchController.GetSearchResultAsync(
                BingSearchResultData.SearchStringWithScriptContent,
                BingSearchResultData.MarketValue,
                BingSearchResultData.FreshnessValue,
                BingSearchResultData.DomainValue).ConfigureAwait(false);
